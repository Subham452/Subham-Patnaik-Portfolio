...
const Life_Journey = () => {
    return (
        <div>
            <div id="Qualification" className='flex flex-col items-center justify-center w-screen h-auto py-20 mt-20 mb-20 overflow-hidden lg:mb-0 lg:py-0 lg:h-screen bg-slate-100 '>
                ...
                <section className='flex flex-row items-center justify-between w-full h-full px-20 py-20 lg:py-0 bg-gradient-to-r from-slate-100 to-slate-100 via-white '>
                    ...
                    <div className='flex gap-[3.3rem] flex-col items-start justify-start w-auto h-full text-slate-900/90 lg:hidden'>
